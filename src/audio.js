...
export class Audio {
   ...
   */
  /** One warning boop. Urgent ones sit higher and shorter: boop, boop, BOOP. */
  lockWarn(urgent = false) {
    this._tone('square', urgent ? 960 : 700, urgent ? 940 : 690, urgent ? 0.07 : 0.1, 0.3);
  }

  /** One cycle of the turret's klaxon: a falling whoop. Repeated, it is a siren. */
  klaxon() {
    this._tone('sawtooth', 660, 420, 0.5, 0.14);
    this._tone('square', 330, 210, 0.5, 0.08);
  }
